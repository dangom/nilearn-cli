...
def save_regions(regions_img, outputfile):
    regions_img.to_filename(outputfile + '_region_extraction.nii.gz')
...
def main(args):
    ...
    regions_percentile_img = extract_region(threshold_percentile_img,
